...
function View3() {
  ...
  const [maxCO2LandCoverName, setMaxCO2LandCoverName] = useState("Evergreen Broadleaf Forest")
  ...
  return (
  <Grid container style={{ height: '80vh', width: '100%', justifyContent: "space-evenly" }} spacing={2}>
      ...
      <Grid container style={{ height: '100%' }} spacing={3}>
        ...
        <Grid item xs={6}>
          <Card style={{ height: '100%', backgroundColor: '#fff', padding: "20px", borderRadius: "5px", boxShadow: "0 0 0 0" }}>
            <BrazilMap layers={["landcover_only_" + maxCO2LandCoverName + "_" + year, "burning_" + year]}
        ...
        <Grid item xs={6}>
          <Card style={{ height: '100%', backgroundColor: '#fff', padding: "20px", borderRadius: "5px", boxShadow: "0 0 0 0" }}>
            <ReactEcharts option={getCO2LossOption()} style={{ height: '100%', width: '100%' }} />
          </Card>
        </Grid>
      </Grid>
    </Grid>

    <Grid item xs={12}  style={{ height: '25%', width:'100%', marginTop: "90px" }}>
      <Card style={{ height: '100%', backgroundColor: '#fff', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: "20px", borderRadius: "5px", boxShadow: "0 0 0 0" }}>
    <Box width="100%" maxWidth={1000}> {/* Adjust maxWidth as needed */}
      <ReactEcharts
    ...
    {/* Slider Grid Item */}
    <Grid item xs={12} style={{ height: '10%', marginTop: "40px" }}> {/* Adjust the height and margin as needed */}
